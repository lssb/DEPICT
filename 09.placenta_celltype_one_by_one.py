...
def train_one_position(position_index):
    ...
    res_dir = "res/placenta_CellType200_one_by_one/" + str(position_index) + "/"
...
res_seed = []
for i in [264, 265, 266, 267, 268, 269, 270, 271]:
...
# [839239, 507864, 729255, 654388, 36794, 251, 466391, 594927]